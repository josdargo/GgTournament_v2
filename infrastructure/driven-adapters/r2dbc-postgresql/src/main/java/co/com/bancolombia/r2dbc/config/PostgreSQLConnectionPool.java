...
public class PostgreSQLConnectionPool {
    ...
    public ConnectionPool getConnectionConfig(){
        ...
        pgProperties.setPort(DEFAULT_PORT);
        pgProperties.setUsername("postgres");
        pgProperties.setPassword("pass");
        pgProperties.setSchema("public");

        return buildConnectionConfig(pgProperties);
    }


	@Bean
	public ConnectionPool buildConnectionConfig(PostgresqlConnectionProperties properties) {
